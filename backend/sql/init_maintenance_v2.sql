...
CREATE TABLE IF NOT EXISTS maintenance_records (
    ...
    record_id CHAR(66) NOT NULL UNIQUE,
    root_record_id CHAR(66) NOT NULL,
    previous_record_id CHAR(66) DEFAULT NULL,
    superseded_by_record_id CHAR(66) DEFAULT NULL,
    aircraft_reg_no VARCHAR(30) NOT NULL,
    aircraft_type VARCHAR(50) NOT NULL,
    job_card_no VARCHAR(50) NOT NULL,
    revision INT NOT NULL DEFAULT 1,
    ata_code VARCHAR(30) NOT NULL,
